...
<head>
	...
	<title>FreshyFarm Homepage</title>
...
<body>
	...
	<div class="header">
		...
		<a href="BuyerHomepage.php"><img id="logo" src="../portal_files/logo1.png"></a>
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<div class="carousel-item active">
					<img class="images1" src="../Images/wallpapers/frontpic.jpeg" height="500px" width="1350px" alt="...">
				</div>
				<div class="carousel-item">
	...
	<div class="morefooter">
		<div class="call">
			...
			<a href="#" style="color:black;">+233 (0)247652755</a>
		</div>
	...
	<div class="instaid">
		<div class="text"><a href="#" style="color:black;">@FreshyFarm</a></div>
		<div class="gmailid">
			<a href="#" class="hypher" style="color:black;">FreshyFarm6@gmail.com</a></div>

	</div>


	<div class="copy">
		<h5 style="test-align:center; padding-top:40px;margin-left:650px; background-color:'grey';">Copyright &copy; 2023 by www.FreshyFarm.com</h5>
	</div>
</body>
