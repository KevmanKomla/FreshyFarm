...
<style>
    body {
        /*background-image: url(../Images/wallpapers/frontpic.jpeg);*/
    ...
    <form action="insert_product.php" method="post" enctype="multipart/form-data">
        ...
        <table id="tab" align="center" width="600" border=3>
            <tr id="ins" align="center">
                <td colspan=4>
                    <h2 style="color: white;">Insert New Product Here</h2>
                </td>
            </tr>
            ...
            <tr id="protitle">
                <td align="center"><b style="color: white;">Product Title:</b></td>
                <td colspan=2><input type="text" name="product_title" size="58" required></td>
            </tr>

            <tr id="procat">
                <td align="center"><b style="color: white;">Product Categories:</b></td>
                <td colspan=2>
                    <select name="product_cat" required>
                        <option style="color: white;">Select a Category</option>
                        <?php
            ...
            <tr id="prostock">
                <td align="center"><b style="color: white;">Product type : <br></b></td>
                <td colspan=2><input type="text" name="product_type" required></td>
            </tr>

            <tr id="procalender">
                <td align="center"><b style="color: white;">Product Expiry : <br></b></td>
                <td colspan=2> <input type="date" name="bday"></td>
            </tr>
            <tr id="proimg">
                <td align="center"><b style="color: white;">Product Image :</b></td>
                <td colspan=2><input type="file" name="product_image"></td>
            </tr>

            <tr id="prostock">
                <td align="center"><b style="color: white;">Product Stock : <br>(In kg)</b></td>
                <td colspan=2><input type="text" name="product_stock" required></td>
            </tr>

            <tr id="propriceMax">
                <td align="center"><b style="color: white;">Product MRP : <br>(Per kg)</b></td>
                <td colspan=2><input type="text" name="product_price" required></td>
            </tr>
            <tr id="propriceMin">
                <td align="center"><b style="color: white;">Product Base Price : <br>(Per kg)</b></td>
                <td colspan=2><input type="text" name="product_price" required></td>
            </tr>
            <tr id="prodesc">

                <td align="center"><b style="color: white;">Product Description:</b></td>
                <td colspan=2><textarea name="product_desc" id="" cols="40" rows="8"></textarea></td>
            </tr>

            <tr id="prokey">
                <td align="center"><b style="color: white;">Product Keywords:</b></td>
                <td colspan=2><input type="text" name="product_keywords" size="58"></td>
            </tr>

            <tr id="dev">
                <td align="center"><b style="color: white;">Delivery :</b></td>
